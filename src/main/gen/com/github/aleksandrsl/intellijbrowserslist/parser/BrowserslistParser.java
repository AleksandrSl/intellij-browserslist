...
public class BrowserslistParser implements PsiParser, LightPsiParser {
  ...
  public static boolean baselineQuery(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "baselineQuery")) return false;
    if (!nextTokenIs(builder_, BASELINE)) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, BASELINE_QUERY, null);
    result_ = consumeToken(builder_, BASELINE);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, baselineQuery_1(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, baselineQuery_2(builder_, level_ + 1)) && result_;
    result_ = pinned_ && baselineQuery_3(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }

  // INTEGER | NEWLY AVAILABLE | WIDELY AVAILABLE (ON TIME)?
  private static boolean baselineQuery_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "baselineQuery_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, INTEGER);
    if (!result_) result_ = parseTokens(builder_, 0, NEWLY, AVAILABLE);
    if (!result_) result_ = baselineQuery_1_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // WIDELY AVAILABLE (ON TIME)?
  private static boolean baselineQuery_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "baselineQuery_1_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, WIDELY, AVAILABLE);
    result_ = result_ && baselineQuery_1_2_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (ON TIME)?
  private static boolean baselineQuery_1_2_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "baselineQuery_1_2_2")) return false;
    baselineQuery_1_2_2_0(builder_, level_ + 1);
    return true;
  }

  // ON TIME
  private static boolean baselineQuery_1_2_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "baselineQuery_1_2_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, ON, TIME);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // WITH_DOWNSTREAM?
  private static boolean baselineQuery_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "baselineQuery_2")) return false;
    consumeToken(builder_, WITH_DOWNSTREAM);
    return true;
  }

  // INCLUDING_KAIOS?
  private static boolean baselineQuery_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "baselineQuery_3")) return false;
    consumeToken(builder_, INCLUDING_KAIOS);
    return true;
  }
  ...
  static boolean queries_(PsiBuilder builder_, int level_) {
    ...
    result_ = queries__0(builder_, level_ + 1);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, queryExpression(builder_, level_ + 1));
    result_ = pinned_ && queries__2(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }

  // !(EOL | COMMENT | '[' | <<eof>>)
  private static boolean queries__0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "queries__0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !queries__0_0(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // EOL | COMMENT | '[' | <<eof>>
  private static boolean queries__0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "queries__0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, EOL);
    if (!result_) result_ = consumeToken(builder_, COMMENT);
  ...
  private static boolean queries__2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "queries__2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!queries__2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "queries__2", pos_)) break;
    }
    return true;
  }

  // EOL queryExpression|COMMENT|EOL !'['
  private static boolean queries__2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "queries__2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = queries__2_0_0(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, COMMENT);
    if (!result_) result_ = queries__2_0_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // EOL queryExpression
  private static boolean queries__2_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "queries__2_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, EOL);
  ...
  // EOL !'['
  private static boolean queries__2_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "queries__2_0_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, EOL);
    result_ = result_ && queries__2_0_2_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // !'['
  private static boolean queries__2_0_2_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "queries__2_0_2_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
  ...
  public static boolean query(PsiBuilder builder_, int level_) {
    ...
    result_ = baselineQuery(builder_, level_ + 1);
    if (!result_) result_ = statsQuery(builder_, level_ + 1);
  ...
  private static boolean queryExpression_recover_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    result_ = consumeTokenFast(builder_, EOL);
    if (!result_) result_ = consumeTokenFast(builder_, COMMENT);
    return result_;
  }
  ...
  private static boolean query_recover_0(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = consumeTokenFast(builder_, LBRACKET);
    return result_;
  }

  /* ********************************************************** */
  // !(EOL | COMMENT | OR | AND | '[' | <<eof>>) query
  static boolean query_with_recover(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "query_with_recover")) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_);
    result_ = query_with_recover_0(builder_, level_ + 1);
    pinned_ = result_; // pin = 1
    result_ = result_ && query(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, pinned_, BrowserslistParser::query_recover);
    return result_ || pinned_;
  }

  // !(EOL | COMMENT | OR | AND | '[' | <<eof>>)
  private static boolean query_with_recover_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "query_with_recover_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !query_with_recover_0_0(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // EOL | COMMENT | OR | AND | '[' | <<eof>>
  private static boolean query_with_recover_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "query_with_recover_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, EOL);
    if (!result_) result_ = consumeToken(builder_, COMMENT);
  ...
  private static boolean sectionHeader_recover_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    result_ = consumeTokenFast(builder_, COMMENT);
    if (!result_) result_ = consumeTokenFast(builder_, EOL);
    return result_;
  }
  ...
  static boolean singleQuery_(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && query_with_recover(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  public static boolean supportsQuery(PsiBuilder builder_, int level_) {
    ...
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, SUPPORTS_QUERY, "<supports query>");
    result_ = supportsQuery_0(builder_, level_ + 1);
    result_ = result_ && consumeTokens(builder_, 1, SUPPORTS, FEATURE);
  ...
  // (PARTIALLY | FULLY)?
  private static boolean supportsQuery_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "supportsQuery_0")) return false;
    supportsQuery_0_0(builder_, level_ + 1);
    return true;
  }

  // PARTIALLY | FULLY
  private static boolean supportsQuery_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "supportsQuery_0_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, PARTIALLY);
    if (!result_) result_ = consumeToken(builder_, FULLY);
    return result_;
  }
