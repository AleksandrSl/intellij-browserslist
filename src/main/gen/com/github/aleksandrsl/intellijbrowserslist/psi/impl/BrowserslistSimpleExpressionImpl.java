...
public class BrowserslistSimpleExpressionImpl extends BrowserslistQueryExpressionImpl implements BrowserslistSimpleExpression {

  public BrowserslistSimpleExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public BrowserslistQuery getQuery() {
    return findChildByClass(BrowserslistQuery.class);
  }
