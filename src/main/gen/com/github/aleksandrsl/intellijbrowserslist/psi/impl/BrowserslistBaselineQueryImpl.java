...
public class BrowserslistBaselineQueryImpl extends BrowserslistQueryImpl implements BrowserslistBaselineQuery {

  public BrowserslistBaselineQueryImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BrowserslistVisitor visitor) {
    visitor.visitBaselineQuery(this);
  }
