...
public class BrowserslistHeadlessSectionImpl extends BrowserslistSectionImpl implements BrowserslistHeadlessSection {

  public BrowserslistHeadlessSectionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BrowserslistVisitor visitor) {
    visitor.visitHeadlessSection(this);
  }
